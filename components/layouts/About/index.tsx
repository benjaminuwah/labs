            ...
            <section className="bg-[#F3F3F2] md:p-20" id="about">
                ...
                <div className="container md:grid grid-cols-2 gap-20 pt-10 md:p-20 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl">
                            We focus on supporting allied African nations by enhancing security capabilities,
                            strenghtening institutions ans delivering sustainable defence solutions.
                        </p>
                    </motion.div>
                </div>
            </section>
